...
<head>
    ...
    <title>Web bán hàng máy tính linh kiên điện tử</title>
    <!-- Bootstrap core CSS-->
...
<body id="page-top">
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        ...
        <a class="navbar-brand mr-1" href="#">Hello <?php echo $_SESSION['admin_name'] ;?></a>
    ...
    <div id="wrapper">
        ...
        <ul class="sidebar navbar-nav">
            <li class="nav-item <?php echo isset($open) && $open == 'admin' ? 'active' : ''?>">
                <a class="nav-link" href="<?php echo modules("admin/indext.php")?>">
                    <i class="fa fa-user-circle"></i>
                    <span>Admin</span>
                </a>
            </li>
            <li class="nav-item <?php echo isset($open) && $open == 'users' ? 'active' : ''?>">
                <a class="nav-link" href="<?php echo modules("user/indext.php")?>">
            ...
            <li class="nav-item <?php echo isset($open) && $open == 'category' ? 'active' : ''?>">
                <a class="nav-link" href="<?php echo modules("category/indext.php")?>">
                    <i class="fa fa-list"></i>
                    <span>Category</span>
                </a>
            </li>
            <li class="nav-item <?php echo isset($open) && $open == 'product' ? 'active' : ''?>">
                <a class="nav-link" href="<?php echo modules("product/indext.php")?>">
