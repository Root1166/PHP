						...
						<tbody>
							<?php $stt=1;foreach($admin as $item):?>
								<tr>
									<td><?php echo $stt?></td>
									<td>
									    <img src="<?php echo upload()?>avartarAdmin/<?php echo $item['avartar']?>" style="width:80px;height:80px">
								    </td>
									<td>
                                        <span href="" class="btn btn-xs <?php echo $item['level']==1 ? 'btn-info' : 'btn-danger'?>">
                                            <?php echo $item['level']==1 ? 'CTV' : 'Admin'?>
										</span>
                                    </td>
